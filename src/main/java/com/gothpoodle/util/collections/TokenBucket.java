	...
	extends AbstractQueue<E> implements BlockingQueue<E>
{
	...
	public TokenBucket(BlockingQueue<E> wrappedQueue, int maxTokens, int perMinute)
	{
		this.wrappedQueue = wrappedQueue;
		this.numTokens = maxTokens;
	...
	public TokenBucketIterator iterator()
	{
		lock.lock();
		try
		{
			return new TokenBucketIterator();
		}
		finally
		{
			lock.unlock();
	...
	private class TokenBucketIterator
